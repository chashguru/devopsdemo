			...
			if (section instanceof CustomEditorSection)
			{
				...
				if (customSection.getSectionConfiguration() instanceof ExternalTaxesSectionConfiguration)
				{
					...
					if (secConfig != null)
					{
						...
						final Label rowLabel = new Label(Labels.getLabel("ankitcockpits.product.externalTaxes"));
						rowLabel.setTooltiptext(Labels.getLabel("ankitcockpits.product.externalTaxes"));
