...
import org.training.cockpits.constants.AnkitCockpitsConstants;
 ...
 */
@SystemSetup(extension = AnkitCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(AnkitCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(AnkitCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						AnkitCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				importImpexFile(context, "/ankitcockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
			}
