...
/**
 * Provides necessary meta information about the ankitcore hmc extension.
 * 
 * 
 * @version ExtGen v4.1
 */
public class AnkitCoreHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(AnkitCoreHMCExtension.class.getName());
