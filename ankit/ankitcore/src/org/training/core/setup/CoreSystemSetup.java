 ...
 */
@SystemSetup(extension = AnkitCoreConstants.EXTENSIONNAME)
public class CoreSystemSetup extends AbstractSystemSetup
{
	...
	public static final String MERCHANDISE = "ankitCustom";
	...
	{
		importImpexFile(context, "/ankitcore/import/common/essential-data.impex");
		importImpexFile(context, "/ankitcore/import/common/countries.impex");
		importImpexFile(context, "/ankitcore/import/common/delivery-modes.impex");

		importImpexFile(context, "/ankitcore/import/common/themes.impex");
		importImpexFile(context, "/ankitcore/import/common/user-groups.impex");
	}
	...
	public void createProjectData(final SystemSetupContext context)
	{
		...
		final ImportData ankitCustomImportData = new ImportData();
		ankitCustomImportData.setProductCatalogName(MERCHANDISE);
		ankitCustomImportData.setContentCatalogNames(Arrays.asList(MERCHANDISE));
		ankitCustomImportData.setStoreNames(Arrays.asList(MERCHANDISE));
		...
		if (importSites)
		{
			...
			new ImportCatalogAwareDataStrategy(context, ankitCustomImportData).importAllData();
		...
		{
			importImpexFile(context, "/ankitcore/import/cockpits/cmscockpit/cmscockpit-users.impex");
			importImpexFile(context, "/ankitcore/import/cockpits/cmscockpit/cmscockpit-access-rights.impex");
		}

		if (importAccessRights && extensionNames.contains("btgcockpit"))
		{
			importImpexFile(context, "/ankitcore/import/cockpits/cmscockpit/btgcockpit-users.impex");
			importImpexFile(context, "/ankitcore/import/cockpits/cmscockpit/btgcockpit-access-rights.impex");
		}

		if (importAccessRights && extensionNames.contains("productcockpit"))
		{
			importImpexFile(context, "/ankitcore/import/cockpits/productcockpit/productcockpit-users.impex");
			importImpexFile(context, "/ankitcore/import/cockpits/productcockpit/productcockpit-access-rights.impex");
			importImpexFile(context, "/ankitcore/import/cockpits/productcockpit/productcockpit-constraints.impex");
		}

		if (importAccessRights && extensionNames.contains("cscockpit"))
		{
			importImpexFile(context, "/ankitcore/import/cockpits/cscockpit/cscockpit-users.impex");
			importImpexFile(context, "/ankitcore/import/cockpits/cscockpit/cscockpit-access-rights.impex");
		}

		if (importAccessRights && extensionNames.contains("reportcockpit"))
		{
			importImpexFile(context, "/ankitcore/import/cockpits/reportcockpit/reportcockpit-users.impex");
			importImpexFile(context, "/ankitcore/import/cockpits/reportcockpit/reportcockpit-access-rights.impex");
		}

		if (extensionNames.contains("mcc"))
		{
			importImpexFile(context, "/ankitcore/import/common/mcc-sites-links.impex");
		}
	...
	private class ImportCatalogAwareDataStrategy
	{
		...
		private void createAndActivateSolrIndex(final String storeName)
		{
			...
			importImpexFile(context, "/ankitcore/import/stores/" + storeName + "/solr.impex");

			createSolrIndexerCronJobs(storeName + "Index");

			importImpexFile(context, "/ankitcore/import/stores/" + storeName + "/solrtrigger.impex");
		...
		private void createStore(final String storeName)
		{
			...
			importImpexFile(context, "/ankitcore/import/stores/" + storeName + "/store.impex");
			importImpexFile(context, "/ankitcore/import/stores/" + storeName + "/site.impex");
		...
		private void createContentCatalog(final String contentCatalogName)
		{
			...
			importImpexFile(context, "/ankitcore/import/contentCatalogs/" + contentCatalogName + "ContentCatalog/catalog.impex",
					true);
			importImpexFile(context, "/ankitcore/import/contentCatalogs/" + contentCatalogName + "ContentCatalog/cms-content.impex",
					false);
			importImpexFile(context, "/ankitcore/import/contentCatalogs/" + contentCatalogName
		...
		private void createProductCatalog(final String productCatalogName)
		{
			...
			importImpexFile(context, "/ankitcore/import/productCatalogs/" + productCatalogName + "ProductCatalog/catalog.impex",
					true);
