...
public class SingleStepCheckoutController extends AbstractCheckoutController
{
	...
	{
		userFacade.setDefaultAddress(checkoutFacade.getAddressDataForId(addressId, true));
	...
	{
		final AddressData addressData = checkoutFacade.getAddressDataForId(addressId, false);
			...
			@RequestParam(value = "createUpdateStatus") final String createUpdateStatus)
	{
		...
		model.addAttribute("noAddresses", userFacade.isAddressBookEmpty());
