...
import org.training.initialdata.constants.AnkitInitialDataConstants;
 ...
 */
@SystemSetup(extension = AnkitInitialDataConstants.EXTENSIONNAME)
public class InitialDataSystemSetup extends AbstractSystemSetup
{
	...
	private static final String IMPORT_MERCHANDISE_DATA = "importAnkitCustomData";
	...
	public List<SystemSetupParameter> getInitializationOptions()
	{
		...
		params.add(createBooleanSystemSetupParameter(IMPORT_MERCHANDISE_DATA, "Import Ankit Custom Merchandise Sample Data", true));
	...
	public void createProjectData(final SystemSetupContext context)
	{
		...
		// importCommonData(context, "ankitinitialdata");
		// This would import a standard store: (one basestore, one cmssite, one product catalog, one content catalog)
		// importStoreInitialData(context, "ankitinitialdata", "yaccelerator", "yaccelerator", Collections.singletonList("yaccelerator"));
		...
		{
			logInfo(context, "Importing Ankit Custom site content...");
			importCommonData(context, "ankitinitialdata");
			importProductCatalog(context, "ankitinitialdata", "ankitCustom");
			importContentCatalog(context, "ankitinitialdata", "ankitCustom");
			importStoreLocations(context, "ankitinitialdata", "ankitCustom");
			importStoreInitialData(context, "ankitinitialdata", "ankitCustom", "ankitCustom",
					Collections.singletonList("ankitCustom"));
			final ImportData hybrisImportData = new ImportData();
			hybrisImportData.setProductCatalogName("ankitCustom");
			hybrisImportData.setContentCatalogNames(Arrays.asList("ankitCustom"));
			hybrisImportData.setStoreNames(Arrays.asList("ankitCustom"));
