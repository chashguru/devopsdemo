...
import org.training.facades.product.data.ApparelProductData;
...
/**
 * Populates {@link ApparelProductData} with genders
 */
public class ApparelProductPopulator implements Populator<ProductModel, ProductData>
{
	...
	public void populate(final ProductModel source, final ProductData target) throws ConversionException
	{
		...
		if (target instanceof ApparelProductData && baseProduct instanceof ApparelProductModel)
		{
